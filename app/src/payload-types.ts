...
export interface Product {
  ...
  billingCycle?: ('daily' | 'weekly' | 'monthly' | '1m' | '3m' | '6m' | '12m' | 'other') | null;
  unit?: string | null;
...
export interface ServiceRequest {
  ...
  name: string;
  phone: string;
  service?: ('internet' | 'sim' | 'camera' | 'tvbox' | 'other') | null;
  address?: string | null;
  note?: string | null;
  source?: ('web' | 'mcp' | 'other') | null;
  status?: ('new' | 'contacted' | 'surveying' | 'done' | 'cancelled') | null;
  updatedAt: string;
  createdAt: string;
}
/**
